...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LAMBDA = 5,                     /* LAMBDA  */
  YYSYMBOL_DOT = 6,                        /* DOT  */
  YYSYMBOL_PREPAR = 7,                     /* PREPAR  */
  YYSYMBOL_POSTPAR = 8,                    /* POSTPAR  */
  YYSYMBOL_9_n_ = 9,                       /* '\n'  */
  YYSYMBOL_YYACCEPT = 10,                  /* $accept  */
  YYSYMBOL_start = 11,                     /* start  */
  YYSYMBOL_lambda_expr = 12                /* lambda_expr  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "'|'", "VARIABLE",
  "LAMBDA", "DOT", "PREPAR", "POSTPAR", "'\\n'", "$accept", "start",
  "lambda_expr", YY_NULLPTR
};
...
{
       9,     8,    11,     4,     5,    10,     6,     2,     3,    15,
      16,     4,     5,    12,     6,    13,    -5,     0,    14
};

static const yytype_int8 yycheck[] =
{
       4,     9,     6,     4,     5,     4,     7,     0,     1,    13,
      14,     4,     5,     9,     7,     6,     9,    -1,     8
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* start: start lambda_expr '\n'  */
#line 33 "lambda.y"
                               {
            createFUN(regs,res);
...
#line 1160 "y.tab.c"
  ...
  case 6: /* lambda_expr: VARIABLE lambda_expr  */
#line 45 "lambda.y"
                                       {
                    res[ptr] = (yyvsp[-1].a) + 'a';
                    ptr++;
...
#line 1169 "y.tab.c"
  ...
  case 7: /* lambda_expr: LAMBDA VARIABLE DOT lambda_expr  */
#line 49 "lambda.y"
                                                  {
                    regs[(yyvsp[-2].a)] = 1;
                  }
